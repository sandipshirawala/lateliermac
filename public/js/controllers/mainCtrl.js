angular.module('mainCtrl', [])
	...
	.controller('mainController', function($scope, $http, Product) {
		...
		if(window.location.pathname == '/lateliermac/public/products'){
		...
		}else if(window.location.pathname == '/lateliermac/public/admin/forum'){
...
*/
		...
		**/
		$scope.submitProduct = function() {
			...
			Product.saveProduct($scope.commentData)
				.success(function(data) {
